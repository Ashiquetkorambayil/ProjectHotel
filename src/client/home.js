...
function home() {
  ...
  <div className="container-xxl bg-white p-0">
    ...
    <Navbar/>
      <div className="container-xxl py-5 bg-dark hero-header mb-5 main-1"  style={{height:'100svh'}}>
        <div className='header-div'>
        <h1  style={{color:'white'}}>Indulge in a symphony of luxury and comfort, where<br/>every stay is a masterpiece of hospitality.</h1>
        <p  style={{color:'white'}}>Welcome to a world where elegance meets unparalleled hospitality.<br/> Our hotel invites you to experience a harmonious blend of luxury<br/> and comfort, where every moment is curated for your utmost<br/> enjoyment. Unwind in style and let us redefine your stay<br/> with a touch of sophistication and warmth.</p>
        </div>
    ...
    <div className="container-xxl py-5">
        <div className="container">
          ...
          {getCusine.map((items, index)=>(
            <ul  key={index} className="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
